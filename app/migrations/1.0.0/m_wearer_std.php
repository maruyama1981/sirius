...
class MWearerStdMigration_100 extends Migration
{
    ...
    public function up()
    {
        $this->morphTable(
            ...
            'indexes' => array(
                new Index('m_wearer_std_pkc', array('job_type_cd', 'm_wearer_std_comb_hkey', 'rntl_cont_no', 'rntl_sect_cd', 'werer_cd'))
            ),        )
        );
    }
}
